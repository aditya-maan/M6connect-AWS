...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        self.standalone = options.standalone; //"alt="{alt}"
        self.emojiTemplate = '<img alt="" class="emojione' + (self.sprite ? '-{uni}" src="' + blankImg + '"/>' : 'emoji" src="{img}"/>');
    ...
    var cdn = { 
		defaultBase: "/sites/all/libraries/emojione/",  //defaultBase:   "/sites/all/libraries/emojione/",  ////
		base: null,
		isLoading: false
	};
