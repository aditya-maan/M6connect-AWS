...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        var sourceValFunc = source.is("TEXTAREA") || source.is("INPUT") ? "val" : "text",
            editor, button, upbutton, sdbutton ,picker, tones, filters, filtersBtns, emojisList, categories, scrollArea,
            app = div({
			...
			upbutton = self.upbutton = div('upbutton',
			    div('button-upload')
            ).attr('title', 'Attachment'),
			sdbutton= self.sdbutton = div('sendbutton',
			    div('button-send')
            ).attr('title', 'Send'),
    ...
    var cdn = { 
		defaultBase: "/sites/all/libraries/emojione/", //"https://cdnjs.cloudflare.com/ajax/libs/emojione/",
		base: null,
		isLoading: false
	};
