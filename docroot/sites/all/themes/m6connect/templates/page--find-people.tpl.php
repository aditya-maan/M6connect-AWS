            ...
            <div id="content" class="column" role="main">
              <div class="box">
                <div class="inner-box">
                  ...
                  <?php print $breadcrumb; ?> <a id="main-content"></a> <?php print $messages; ?> <?php print render($page['help']); ?>
              ...
              <?php ?><div class="pull-right">
                <div class="form-submit people-invite-btn"> <?php echo l('Invite', '/sendinvite-users/nojs', array('html' => TRUE, 'attributes' => array('title'=>'Invite Companies', 'class' => 'use-ajax ctools-modal-assign-dashboard-invite-style'))); ?> </div>
              </div><?php ?>
              <?php print render($title_suffix);*/ ?>
                  ...
                  <div class="row margin-5 dashboard_content">
                    <div class="col-md-8 col-sm-12 col-xs-12 padding-5 margin-bottom-10">
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 padding-5 margin-bottom-10">
