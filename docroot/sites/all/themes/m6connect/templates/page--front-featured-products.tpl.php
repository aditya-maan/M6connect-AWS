...
?>
<?php global $user; ?>
<link rel="stylesheet" href="<?php print $base_path . path_to_theme(); ?>/owl/owl-carousel/owl.carousel.css">
<link rel="stylesheet" href="<?php print $base_path . path_to_theme(); ?>/owl/owl-carousel/owl.theme.css">
<script src="<?php print $base_path . path_to_theme(); ?>/owl/owl-carousel/owl.carousel.js"></script>
<?php if ($user->uid == 0) : ?>
<div id="page">
  <header class="header front_header clearfix">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 text-right"> <?php print render($page['header']); ?> </div>
      </div>
    </div>
  </header>
  <?php if ($page['slider']): ?>
  ...
  <?php endif; ?>
  <div id="main" class="white-bg">
    <div id="content" class="column clearfix" role="main">
      <div class="box clearfix">
        <div class="inner-box clearfix">
          <div class="front_data_tabs clearfix">
            <div class="container">
            ...
            <div class="white-bg">
              <div id="main">
                <div id="content" class="column clearfix" role="main">
                  <div class="box clearfix">
                    <div class="inner-box clearfix">
                      <div class="front_data_tabs clearfix"> <?php print $breadcrumb; ?> <a id="main-content"></a> <?php print render($tabs); ?> <?php print render($page['help']); ?>
                        <?php if ($action_links): ?>
                        <ul class="action-links">
                          <?php print render($action_links); ?>
                        </ul>
