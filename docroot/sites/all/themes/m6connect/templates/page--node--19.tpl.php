...
<div id="page">
    ...
    <div id="content" class="column clearfix" role="main">
      <div class="box clearfix">
        <div class="inner-box clearfix">
          <div class="front_data_tabs clearfix"> <?php print render($tabs); ?> <?php print render($page['help']); ?>
            <?php if ($action_links): ?>
  ...
  <div class="get-in-touch clearfix">
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-md-offset-3"> <?php print $breadcrumb; ?> <a id="main-content"></a> <?php print $messages; ?>
