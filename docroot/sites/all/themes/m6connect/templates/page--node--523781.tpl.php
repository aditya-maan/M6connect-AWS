...
<div id="page">
  ...
  <?php endif; ?>
  <div class="get-in-touch get-in-touch-contact clearfix">
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
          <div class="front_data_tabs clearfix"> <?php print $messages; ?> <?php print render($tabs); ?> <?php print render($page['help']); ?>
            <?php if ($action_links): ?>
          ...
          <?php if ($page['get_in_touch']): ?>
          <?php print render($page['get_in_touch']); ?>
          <?php endif; ?>
          <?php
        ...
        <div id="dashboard">
          <div class="container-fluid">
            ...
            <div class="white-bg">
              ...
              <div class="out_team margin-bottom-45 clearfix">
              ...
              <div class="get-in-touch get-in-touch-contact clearfix">
                <div class="container">
                  <div class="row">
                    <div class="col-md-6 col-md-offset-3"> <?php print $messages; ?>
                      <?php if ($page['get_in_touch']): ?>
                      <?php print render($page['get_in_touch']); ?>
                      <?php endif; ?>
                      <?php
