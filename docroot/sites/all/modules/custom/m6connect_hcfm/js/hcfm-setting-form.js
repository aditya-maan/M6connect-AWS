...
Drupal.behaviors.m6connect_routing_setting = {
  attach: function () {
	...
	jQuery('.hcfm-rs-type-delete-link').click(function(e) {
      ...
      jQuery('#routing-setting-type-dialog').dialog({
		  ...
		  open: function () {
			  ...
			  jQuery(this).html('<div class="text-center" style="padding-bottom:25px;"><strong>Are you sure you want to delete this Fm type?</strong></div>');
