...
<div class="tab-content">
  <div role="tabpanel" class="tab-pane active" id="user_m6id_profile">
    <div class="clearfix onboarding-profile-view">
      ...
      <?php if (array_key_exists(21, $user->roles) || array_key_exists(22, $user->roles) || array_key_exists(3, $user->roles) || $user->uid == $m6user->uid): ?>
    ...
    <?php endif; ?>
      ...
      <?php if (array_key_exists(21, $user->roles) || array_key_exists(22, $user->roles) || array_key_exists(3, $user->roles) || $user->uid == $m6user->uid): ?>
      <div class="clearfix onboarding-profile-view-fifth onboarding-profile-heighlight">
        <div class="panel panel-primary">
