Drupal.theme.prototype.AssignDashboardPopup = function () {
  var html = '';
...
Drupal.theme.prototype.AssignDashboardInvitePopup = function () {
  var html = '';
  html += '<div id="ctools-modal" class="popups-box">';
  html += '  <div class="ctools-modal-content modal-forms-modal-content assign-dashboard-invite-popup-container">';
  html += '    <div class="popups-container">';
